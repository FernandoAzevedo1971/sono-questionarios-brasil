        ...
        <section className="bg-gradient-to-br from-primary-500 to-primary-700 text-white py-12">
          <div className="container mx-auto px-4">
            ...
            <p className="text-lg opacity-90">
              Conheça o Portal de Questionários em Medicina do Sono<br />Dr. Fernando Azevedo
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 max-w-3xl">
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <p className="text-neutral-700 mb-6">
                O Portal de Questionários em Medicina do Sono<br />Dr. Fernando Azevedo tem como missão 
